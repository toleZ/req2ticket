...
export function DeleteSprintModal({ isOpen, sprintName, onClose, onConfirm }) {
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      // falla, sigue abierto con el error arriba, igual que DeleteEpicModal.
      onClose()
    } catch (err) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Eliminar sprint">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-body text-label-secondary">
          ¿Seguro que querés eliminar <span className="font-medium text-label">"{sprintName}"</span>?
