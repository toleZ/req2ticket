...
export function DeleteStoryModal({ isOpen, storyTitle, onClose, onConfirm }) {
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      // falla, sigue abierto con el error arriba, igual que CreateStoryModal.
      onClose()
    } catch (err) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Eliminar historia">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-body text-label-secondary">
          ¿Seguro que querés eliminar <span className="font-medium text-label">"{storyTitle}"</span>?
